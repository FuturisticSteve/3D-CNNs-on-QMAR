...
def parse_opts():
    ...
    parser.add_argument('--testset_path', default='kinetics_test.json', type=str, help='Testset file path')
    ...
    parser.add_argument('--n_finetune_classes', default=700, type=int, help='Number of classes for fine-tuning. n_classes is set to the number when pretraining.')
    ...
    parser.add_argument('--scale_step', default=0.84089641525, type=float, help='Scale step for multiscale croppingsam')
    ...
    parser.add_argument('--lr_steps', default=[10, 20, 30, 40, 50, 60], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
    ...
    parser.add_argument('--n_epochs', default=31, type=int, help='Number of total epochs to run')
    ...
    parser.add_argument('--model', default='resnet', type=str, help='(resnet | preresnet | wideresnet | resnext | densenet | flow')
    ...
    parser.add_argument('--annotation_path_flow', default='kinetics_test.json', type=str, help='Flow training set file path')
    parser.add_argument('--testset_path_flow', default='kinetics_test.json', type=str, help='Flow Testset file path')
    parser.add_argument('--resume_path_flow', default='', type=str, help='Save data (.pth) of previous training')
